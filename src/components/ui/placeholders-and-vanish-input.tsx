...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        'w-full relative h-14 rounded-full overflow-hidden glass-input transition duration-200',
        value && 'bg-muted/50',
      )}
    ...
    >
      ...
      <button
        ...
        className="absolute right-3 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-transparent bg-foreground transition duration-200 flex items-center justify-center"
      >
        <Search
          className={cn(
