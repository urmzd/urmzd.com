---
title: AI Workflows
description: AI tools, Claude Code configuration, and how AI integrates into daily development workflows.
category: ai
order: 0
---
...
Commit messages are generated via `git-ai commit` (aliased as `gai`), which analyzes staged changes and produces Angular Conventional Commit messages automatically.
...
The tool follows the same [commit style](/standards/development-practices#commit-style) conventions enforced across all projects.
