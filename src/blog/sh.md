...
[Marcus Aurelius](https://en.wikipedia.org/wiki/Marcus_Aurelius) led Rome through plague, war, and political betrayal — one of the most turbulent periods in the
...
> [!quote] Marcus Aurelius, *Meditations, 4.3*
...
> [!note]
> Tim Pychyl has an amazing series called Solving the Procrastination Puzzle where he explores this in depth. Here's a link to the first part: [Solving the Procrastination Puzzle](https://www.procrastination.ca)

It's a natural consequence of our evolutionary past. Our brains process millions of different pieces of information at any given moment, and being aware of all of it at once would cause an entirely different issue, [action paralysis](https://en.wikipedia.org/wiki/Analysis_paralysis).
...
[Shane Parrish](https://fs.blog/about/), in his book *Clear Thinking*, goes into the importance-time tradeoff, or as he called it, the ALAP
...
> [!quote] Shane Parrish, *Clear Thinking*
...
- [Mayer, Davis, and Schoorman — An Integrative Model of Organizational Trust (1995)](https://www.jstor.org/stable/258792)
  - *On the three factors people use to evaluate trustworthiness: perceived ability, benevolence, and integrity.*
- [Erik Dane — Reconsidering the Trade-off Between Expertise and Flexibility: A Cognitive Entrenchment Perspective (2010)](https://journals.aom.org/doi/10.5465/amr.35.4.zok579)
  - *On how deepening domain expertise can rigidify mental schemas and limit adaptive thinking.*

## Snippet of the Week

<details>
<summary>Decision Trees — The Algorithm Behind Pruning</summary>
