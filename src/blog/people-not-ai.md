...
Jevons' Paradox[^4] is an economic observation introduced by William Stanley Jevons in 1865. It describes how technological improvements that increase the efficiency of a resource's use tend to lead to _increased_ total consumption of that resource — not decreased. As efficiency lowers the effective cost, demand rises to more than offset the savings. Jevons originally documented this with coal consumption during the Industrial Revolution, but the pattern has been observed across sectors ever since[^5].
