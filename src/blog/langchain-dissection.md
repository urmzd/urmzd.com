...
For those who don't already know, LangChain[^1] is the de-facto prototyping and now ostensibly "production-grade" agentic framework that many teams are adopting. Alongside CopilotKit and LlamaIndex, these new-generation AI frameworks are poorly designed and create the kind of technical debt you wish you never accrued. The companies' solution to their poorly designed abstractions? Introduce overpriced observability tooling and custom enterprise solutions — to problems they created. Imagine someone poisoning a well and then offering you the antidote. You'd probably avoid them altogether.
