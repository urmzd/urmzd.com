---
title: "Hey, I'm Urmzd!"
description: "My welcome message to the world"
pubDate: 2025-01-31
...
As is often the case, the responsibilities of adulthood have pushed my love affairs onto an ever growing backlog. As a Software Engineer, this effectively meant that
I'd likely never get back to it.

However, I couldn't accept that. As part of a larger initiative to pay homage to my heritage and to the <PreviewLink client:load href="https://en.wikipedia.org/wiki/Ahura_Mazda">name</PreviewLink> my father gave me.
I decided to block off some time and start working on this blog. I plan to explore history, martial arts, technology, art, music, science, math and philosophy,
...
As someone who values transparency and honesty, all of the contents for this site are published on <PreviewLink client:load href="https://github.com/urmzd/urmzd.com">github.com/urmzd/urmzd.com</PreviewLink>.
...
A small note before we continue, all blog posts will comprise of small snippets at the end of them, and they differ from the topic being covered. I hope that by sharing small snippets
from different domains, it'll promote people to explore topics beyond what they know or believe they know.
...
- Honesty: *The pursuit and belief of absolute truth within oneself.*
- Freedom: *A state in which one is unbounded by the assumptions created internally, or externally*
- Family: *Relationships in which the unrequited kindness received produce profound changes to the state of one's life*
...
Modern LLMs like ChatGPT, Claude, Gemini and others convert text into high-dimensional vectors called **embeddings** — numerical representations that capture semantic meaning. Words, sentences, or entire documents that are similar in meaning end up as vectors pointing in similar directions.
...
- <PreviewLink client:load href="https://www.amazon.com/Four-Thousand-Weeks-Management-Mortals/dp/0374159122">Time Management for Mortals: Oliver Burkeman</PreviewLink>
