...
description: "Scaffold a complete Node/TypeScript project with CI/CD, release pipeline, sr.yaml, .envrc, and standard files. Uses pnpm and biome. Use when creating a new Node.js app, TypeScript library, or website, or when the user mentions \"new Node project\", \"pnpm init\", \"TypeScript scaffold\", or \"Astro site\"."
