---
title: "CLI Standards"
description: "Mandatory CLI standards for all urmzd/* tools: argument parser selection, self-update requirement, output format flag, global flags, and install.sh. Use when building, reviewing, or auditing any CLI tool in this portfolio. These rules override build-cli where they conflict."
