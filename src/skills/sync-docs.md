...
description: "Audit and synchronize project documentation. Detect staleness, fix drift, and keep cross-references consistent across whatever docs the project has. Delegates file-specific rules to the skills that own them. Use after feature changes, refactors, or when docs may be stale. Can be run as a scheduled agent or invoked manually."
