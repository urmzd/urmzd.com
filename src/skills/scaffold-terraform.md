...
description: "Scaffold a Terraform infrastructure project with CI/CD (plan on PR, apply on push), AWS OIDC auth, justfile, .envrc, and standard files. Use when creating infrastructure repos, or when the user mentions \"new Terraform project\", \"terraform init\", \"AWS infra\", or \"infrastructure scaffold\"."
