...
description: "Generate a spec-compliant llms.txt file for any project by analyzing its codebase, docs, and public URLs. Use when creating an llms.txt, making a project LLM-discoverable, or when the user mentions \"llms.txt\" in the context of generating or scaffolding one."
category: "ai"
---
