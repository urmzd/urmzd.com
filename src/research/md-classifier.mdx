...
features:
  - title: "Symptom-to-Diagnosis CNN"
    description: "Predicts medical conditions from natural language with 93% accuracy."
    icon: "Brain"
  - title: "One-Hot Encoding"
    description: "56x4210 word-stem matrix with Witten-Bell synthetic sample augmentation."
    icon: "Code"
  - title: "FastText Embeddings"
    description: "Unsupervised word embeddings trained on medical corpus for comparison."
    icon: "FileText"
  - title: "Multi-Source Scraping"
    description: "Training data scraped from Mayo Clinic, UpToDate, Healthline, and NHS."
    icon: "FlaskConical"
  - title: "Multi-Class Classification"
    description: "Classifies migraines, depression, and tetanus with per-class precision metrics."
    icon: "BarChart3"
  - title: "Pipeline Comparison"
    description: "Side-by-side evaluation proving sparse representations beat learned embeddings."
    icon: "Activity"
---
