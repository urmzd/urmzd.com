...
tagline: "CNN image classification on an 85-image dataset of rabbits and hares"
...
features:
  - title: "CNN Architecture"
    description: "Convolutional neural network designed for binary classification of rabbits vs hares."
    icon: "Layers"
  - title: "Small-Dataset Learning"
    description: "Training techniques for just 85 web-scraped images without specialized hardware."
    icon: "Image"
  - title: "Stratified K-Fold CV"
    description: "Cross validation strategy to reliably evaluate models on small, unbalanced data."
    icon: "Shuffle"
  - title: "Web Scraping Pipeline"
    description: "Automated collection of training images from Eastern cottontail and European hare sources."
    icon: "Globe"
  - title: "Dropout Regularization"
    description: "Regularization layers to combat overfitting on the limited training set."
    icon: "Shield"
