...
features:
  - title: "Genetic Operators"
    description: "Crossover, mutation, and selection operators for evolving register-machine program populations."
    icon: "Dna"
  - title: "Benchmark Datasets"
    description: "Built-in support for Iris classification and OpenAI Gym reinforcement learning benchmarks."
    icon: "FlaskConical"
  - title: "Experiment Tracking"
    description: "Fitness, diversity, and convergence metrics tracked across all evolutionary generations."
    icon: "BarChart3"
  - title: "Rust Performance"
    description: "Core evolution engine written in Rust for maximum computational throughput."
    icon: "Cpu"
  - title: "Python Analysis"
    description: "Python scripting layer for experiment visualization, plotting, and statistical analysis."
    icon: "Brain"
  - title: "Configurable Runs"
    description: "Fine-tune population size, mutation rates, and tournament selection parameters via TOML."
    icon: "Settings"
demo:
  kind: "image"
  images:
