...
features:
  ...
  - title: "Experiment Tracking"
    description: "Fitness, diversity, and convergence tracking across generations."
    icon: "BarChart3"
  - title: "Rust Performance"
    description: "Core evolution engine written in Rust for maximum computational throughput."
    icon: "Cpu"
  - title: "Python Analysis"
    description: "Scripting layer for experiment visualization and statistical analysis."
    icon: "Brain"
  - title: "Configurable Runs"
    description: "Fine-tune population size, mutation rates, and tournament selection parameters."
    icon: "Settings"
demo:
  kind: "image"
  images:
