...
export const projects: Project[] = [
  ...
  },
  {
    slug: 'linear-gp',
    title: 'Linear GP',
    tagline: 'Linear genetic programming framework',
    description:
      'A framework for linear genetic programming experiments, combining Rust performance with Python scripting for analysis. Run evolutionary algorithms on classification tasks and visualize the results across generations.',
    status: 'active',
